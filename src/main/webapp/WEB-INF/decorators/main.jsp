<%@page import="com.carrierinfo.carriercommerce.security.LoginModule"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
        <title>CarrierCommerce - <sitemesh:write property='title'/></title>
        <meta name="description" content="A simple webapp for SUPINFO students." />
        <meta name="author" content="@bargenson" />
        <link rel="stylesheet" href="/styles/carriercommerce.css" type="text/css"  media="screen"/>
	...
	<body>
		<header class="topbar-wrapper" style="z-index: 5;">
		    <div class="topbar">
		      	<div class="fill">
		        	<div class="container">
		          		<h3><a href="/">CarrierCommerce</a></h3>
						<ul>
